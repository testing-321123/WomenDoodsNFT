        ...
        <div className="flex items-center container mx-auto max-w-7xl justify-between h-full">
          ...
          <Link href="#">
            <a className="text-2xl font-bold">
              <span className="pr-2 text-transparent bg-clip-text bg-gradient-to-br from-pink-400 to-red-600">
                Women
              </span>
              Doods
            </a>
          ...
          <nav aria-label="Contact Menu">
            <ul className="flex items-center space-x-6">
              ...
              <li>
                <a href="https://twitter.com/womendoods" target="_blank" rel="noreferrer">
                  <svg
                    className="w-7 h-7"
                    stroke="currentColor"
                    fill="currentColor"
